...
|---|---|---|---|---|---|---|
| `plan-2026-06-12-qa-python-upload-first` | UPGRADE | [`upgrade_to_settle/plan-2026-06-12-qa-python-upload-first.md`](upgrade_to_settle/plan-2026-06-12-qa-python-upload-first.md) | `开发中` | Auto (Reviewer) | 2026-06-12 | §1.2 F 字段已通；无锁定切换/badge 映射仍偏 Java |
