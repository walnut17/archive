...
> 这是一个完全由AI迭代开发的投委会档案管理系统，主要服务于从事不良资产投资的小公司。系统主要包含两大块特殊的能力：（一）对不良资产行业档案管理、任务管理能力进行专属优化，使agent可以在LLM服务的加持下，按业务逻辑进行分析和信息提取，对业务推进起到直接的推进和辅助作用；（二）使整个项目轻型化、低成本化，允许使用方在较低配置下（案例服务器运行环境为12核，1.9GHz，27.6G硬盘，250GSSD+4T raid硬盘），尽量利用LLM服务和本地服务器的运行能力，搭建自己的内部管理能力，同时避免将核心材料上传到大型知识库服务商。
>
