...
> **本表应保持短**：出站即删。当前 **2** 条 `PENDING`（其余已升格 `plan-2026-06-11-*`，见 TASKS）。

| ID | 来源轮次 | 来源 Bug | 严重度 | 问题摘要 | 为何不能当轮小修 | 提交人 | 提交时间 | 出站链（plan / docs） | 状态 |
|---|---|---|---|---|---|---|---|---|---|
| **C-0611-06** | round-0611 | T-0611-12/13 | P1 | Agent `sources` 契约与检索来源 | 小修已 emptyList；验收标准待决 | 阿根廷 | 2026-06-11 | round §4 CLOSED | `PENDING` |
